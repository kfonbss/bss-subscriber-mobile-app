...
import 'package:kfon_subscriber/common/bloc/home_enquiry_form/home_enquiry_form_state.dart';
import 'package:kfon_subscriber/common/bloc/home_enquiry_form/home_enquiry_form_cubit.dart';
...
class _HomeEnquiryFormState extends State<HomeEnquiryForm> {
  final HomeEnquiryFormCubit _subscriptionFormCubit = HomeEnquiryFormCubit();
                          ...
                          () =>
                              state is ShowPreview
                                  ? _subscriptionFormCubit.submitForm(
                                    useCase: sl<HomeEnquiryFormUseCase>(),
                                    params: params,
                                  )
                                  : state is ShowNameForm
                                  ? _subscriptionFormCubit.validateNameForm(
                                    params: params,
                                  )
                                  : state is ShowLocationForm
                                  ? _subscriptionFormCubit.validateLocationForm(
                                    params: params,
                                  )
                                  : _subscriptionFormCubit.validateContactForm(
                                    params: params,
                                  ),
                      secondaryButtonCallback:
                          () =>
                              state is ShowPreview
                                  ? _subscriptionFormCubit.showContactForm()
                                  : state is ShowContactForm
                                  ? _subscriptionFormCubit.showLocationForm()
                                  : _subscriptionFormCubit.showNameForm(),
