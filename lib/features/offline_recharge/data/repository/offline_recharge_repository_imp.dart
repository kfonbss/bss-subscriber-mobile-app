...
class OfflineRechargeRepositoryImp extends OfflineRechargeRepository {
  ...
  OfflineRechargeRepositoryImp({required DioClient client}) : _client = client;

  @override
  Future<Either<Failure, OfflineRechargeDataEntity>> getRechargeData(
    String subscriberUuid,
  ) async {
    final response = await _client.get(
      ApiUrls.subscriberDetailsURL(subscriberUuid: subscriberUuid),
    );
